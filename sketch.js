...
function setup() {
	...
	bob1 = new BobObject(250,500,35);
	bob2 = new BobObject(320,500,35);
	bob3 = new BobObject(390,500,35);
	bob4 = new BobObject(460,500,35);
	bob5 = new BobObject(530,500,35);
...
function keyPressed(){
	...
	if(keyCode === 52) {
		...
		Matter.Body.applyForce(bob4.body,bob4.body.position,{x:1000,y:1000});
